...
def run_module():
    ...
    try:
        ...
        if target == "alias":
            ...
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.unbound_host_alias import (
                Alias as Target_Obj,
            )
            ...
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.unbound_dot import (
                DnsOverTls as Target_Obj,
            )

        elif target == "unbound_forward":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.unbound_forward import (
                Forward as Target_Obj,
            )
            ...
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.package import (
                Package,
            )
            ...
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_general import (
                General as Target_Obj,
            )
            ...
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_bgp_neighbor import (
                Neighbor as Target_Obj,
            )

        elif target == "frr_bgp_prefix_list":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_bgp_prefix_list import (
                Prefix as Target_Obj,
            )

        elif target == "frr_bgp_route_map":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_bgp_route_map import (
                RouteMap as Target_Obj,
            )

        elif target == "frr_bgp_community_list":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_bgp_community_list import (
                Community as Target_Obj,
            )

        elif target == "frr_bgp_as_path":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_bgp_as_path import (
                AsPath as Target_Obj,
            )

        elif target == "frr_ospf_general":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf_general import (
                General as Target_Obj,
            )

        elif target == "frr_ospf3_general":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf3_general import (
                General as Target_Obj,
            )

        elif target == "frr_ospf3_interface":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf3_interface import (
                Interface as Target_Obj,
            )

        elif target == "frr_ospf_prefix_list":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf_prefix_list import (
                Prefix as Target_Obj,
            )

        elif target == "frr_ospf_interface":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf_interface import (
                Interface as Target_Obj,
            )

        elif target == "frr_ospf_route_map":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf_route_map import (
                RouteMap as Target_Obj,
            )

        elif target == "frr_ospf_network":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf_network import (
                Network as Target_Obj,
            )

        elif target == "frr_rip":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_rip import (
                Rip as Target_Obj,
            )

        elif target == "bind_general":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.bind_general import (
                General as Target_Obj,
            )

        elif target == "bind_blocklist":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.bind_blocklist import (
                Blocklist as Target_Obj,
            )

        elif target == "bind_acl":
            from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.bind_acl import (
                Acl as Target_Obj,
            )
